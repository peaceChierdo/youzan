  ...
  <div class="container " style="min-height: 581px;">
    <div class="content">
      ...
      <div class="order-related">
        ...
        <div class="block block-list list-vertical">
          <router-link class="block-item link clearfix ico-setting js-login" href="https://h5.youzan.com/v2/buyer/member/setting" target="_self" to="/address">
            <p class="title-info c-black font-size-14">管理收货地址</p>
          </router-link>
